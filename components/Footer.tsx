        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="flex items-center gap-2 text-gray-500 hover:text-black transition-colors font-medium text-sm group"
              >
                Instagram
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/servicios/google-my-business" className="text-gray-600 hover:text-black transition-colors">Google My Business</Link></li>
              <li><Link to="/servicios/diseno-web-restaurantes" className="text-gray-600 hover:text-black transition-colors">Diseño Web Premium</Link></li>
              ...
              <li><Link to="/servicios/seo-gastronomico" className="text-gray-600 hover:text-black transition-colors">SEO Gastronómico</Link></li>
