...
const FinalCTA: React.FC = () => {
  ...
  return (
    <section id="contact" ref={ref} className="relative py-20 md:py-32 px-6 md:px-12 overflow-hidden flex flex-col items-center justify-center font-['Inter']">
      ...
      <div className={`relative z-10 max-w-4xl w-full transition-all duration-1000 ease-out transform ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="bg-white rounded-[2.5rem] p-8 md:p-12 md:py-10 shadow-[0_48px_80px_-20px_rgba(0,0,0,0.2)] relative overflow-hidden">
          <div className="relative z-10">
            {/* Anagram Logo - Centered */}
            <div className="flex justify-center mb-8">
              <img src="/anagram.png" alt="Motions Anagram" className="h-10 md:h-12 w-auto" />
            </div>

            {/* Premium Copy - Centered */}
            <div className="mb-10 text-center">
              <h2 className="text-3xl md:text-5xl text-black font-semibold mb-4 tracking-tight leading-[1.1]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest block text-center">¿En qué podemos ayudarte?</label>
