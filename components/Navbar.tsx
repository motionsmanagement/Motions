      ...
      <div className="fixed top-4 md:top-6 left-0 right-0 z-50 flex justify-center px-4 transition-all duration-300">
        <nav className={`rounded-full px-4 md:px-10 py-2.5 md:py-3 flex items-center justify-between w-full max-w-6xl backdrop-blur-xl border transition-all duration-300 ${themeClass}`}>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <a href="#contacto" className={`hidden md:block px-4 md:px-6 py-2 rounded-full text-xs md:text-sm font-semibold transition-all shadow-lg tracking-tight flex items-center gap-2 ${showDarkNavbar ? "bg-black text-white hover:bg-gray-800" : "bg-black/40 backdrop-blur-xl border border-white/30 text-white hover:bg-black/50"}`}>
              Empezar Ahora
              <svg 
                  viewBox="0 0 24 24" 
                  fill="none" 
            ...
            <a href="https://wa.me/34919610420" className={`md:hidden px-4 py-2 rounded-full text-xs font-semibold transition-all shadow-lg tracking-tight flex items-center gap-2 ${showDarkNavbar ? "bg-black text-white hover:bg-gray-800" : "bg-black/40 backdrop-blur-xl border border-white/30 text-white hover:bg-black/50"}`}>
              Empezar Ahora
              <svg 
                  viewBox="0 0 24 24" 
                  fill="none" 
