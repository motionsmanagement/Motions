                      ...
                      <>
                        ...
                        <form onSubmit={(e) => handleSubmit(e, job.title)} className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-10">
                          ...
                          <div className="md:col-span-2 pt-6">
                            <button type="submit" className="w-full md:w-auto px-10 py-3.5 bg-black text-white rounded-full font-bold text-sm shadow-xl hover:bg-neutral-800 transition-all hover:scale-[1.02] active:scale-95">
                              Enviar Candidatura
                            </button>
                          </div>
                        </form>
